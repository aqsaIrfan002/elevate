...
const ProjectCard = ({ project, isSecondItem, isAnimating }) => {
    return (
        <div
            className={`rounded-2xl transition-all duration-700 ease-in-out ${isSecondItem ? 'h-80' : 'h-96'}`}
            style={{
                width: 'calc(50% - 8px)',
                flexShrink: 0,
        ...
        >
            <div className="relative z-10 p-6 flex flex-col justify-end h-full text-white">
                <h4 className="text-lg font-[400] mb-2">{project.title}</h4>
                <p className="font-[300] mb-4">{project.description}</p>
                <button className="bg-white text-gray-900 px-5 py-2 rounded-full font-[400] hover:bg-black hover:text-white transition-colors w-fit">
                    Learn more
                </button>
            </div>
        </div>
    ...
    return (
        <div className="min-h-screen bg-[#EBEBEB] text-black tracking-tight" style={{ fontFamily: 'DM Sans' }}>
            ...
            <nav className="absolute top-10 left-0 right-0 z-50">
                <div className="max-w-7xl mx-auto flex items-center justify-between px-36">
            ...
            <section className="relative min-h-screen">
                ...
                <div className="relative z-10 text-left text-white max-w-7xl mx-auto flex items-center">
                    <div className="grid lg:grid-rows-1 items-start gap-12 pt-42 px-36">
                        <div>
                            <AnimatedText 
                                className="text-3xl md:text-4xl lg:text-5xl font-[300] leading-tight tracking-tight mb-6"
                                delay={0.5}
                            >
                            ...
                            <AnimatedSection delay={0.6}>
                                <p className="text-sm md:text-base font-[300] leading-relaxed">
                                    Transform your vision into reality with our premium residential and<br />
                                    commercial developments. We create exceptional spaces where <br />
                                    innovation meets tradition, uncompromising quality, delivering properties <br />
            ...
            <section className="py-20 px-6">
                <div className="max-w-7xl mx-auto px-36">
                    <div className="grid lg:grid-rows-1 items-center">
                        <AnimatedSection>
                            <h2 className="text-3xl lg:text-4xl mb-8 leading-tight">
                                ...
                                <em className="font-normal" style={{ fontFamily: 'Playfair Display, serif' }}>sustainable</em> practices, <br />and{' '}
                            ...
                            <AnimatedSection direction="left" delay={0.3}>
                                <div className="flex flex-col justify-between h-full">
                                    ...
                                    <div>
                                        ...
                                        <button className="mt-6 bg-black text-white pl-5 pr-1 py-1 rounded-full flex items-center gap-2 hover:bg-gray-800 transition-colors">
                                            View all projects
                                            <div className="bg-white text-black rounded-full p-1.5 hover:bg-black hover:text-white transition-colors">
                                    ...
                                    <div className="relative w-full h-96">
                                        ...
                                        <div className="absolute bottom-0 flex gap-2" style={{ left: `calc(65% + 10px)` }}>
                                            <button
                                                ...
                                                className="bg-white text-black rounded-full p-1.5 hover:bg-black hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                            ...
                                            <button
                                                onClick={nextSlide}
                                                disabled={isAnimating}
                                                className="bg-black text-white rounded-full p-1.5 hover:bg-white hover:text-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
            ...
            <AnimatedSection className="relative grid grid-cols-1 lg:grid-cols-2 min-h-[80vh] bg-white rounded-4xl overflow-hidden my-4 mx-auto">
                <AnimatedSection direction="left" delay={0.2}>
                    <div className="w-full h-full">
                        <div
                            className="w-full h-full bg-cover bg-center rounded-l-4xl"
                            style={{
                                backgroundImage: `
                ...
                <AnimatedSection direction="right" delay={0.4} className="p-16 flex items-center">
                    <div> 
                        <AnimatedText 
                            className="text-3xl lg:text-4xl mb-6 italic" 
                        ...
                        <AnimatedText 
                            className="text-4xl lg:text-5xl mb-6 leading-tight tracking-tight"
                            stagger={true}
                        >
                    ...
                    <div className="grid lg:grid-cols-[40%_60%] gap-4">
                        <AnimatedSection direction="left">
                            <div className="h-full bg-black text-white font-[300] p-6 rounded-2xl">
                                <h3 className="text-3xl lg:text-4xl mb-4 leading-tight tracking-tight">
                                    Ready to Start <br />
                                    Your Next <br />
                                    Chapter?
                                </h3>
                        ...
                        <AnimatedSection direction="right" delay={0.2}>
                            <div>
                                <div className="grid md:grid-cols-3 gap-8 p-2 mb-4">
                                    <AnimatedSection delay={0.1}>
                                        <div>
                                            <div className="text-4xl lg:text-5xl mb-2">
                                                50+
                                            </div>
                                            <p className="text-lg leading-tight">Projects <br />Completed</p>
                                        </div>
                                    </AnimatedSection>
                                    ...
                                    <AnimatedSection delay={0.2}>
                                        <div>
                                            ...
                                            <p className="text-lg leading-tight">Years <br />Experience</p>
                                        </div>
                                    </AnimatedSection>
                                    ...
                                    <AnimatedSection delay={0.3}>
                                        <div>
                                            ...
                                            <p className="text-lg leading-tight">Happy <br />Homeowners</p>
                                        </div>
                                    </AnimatedSection>
                                </div>
                                ...
                                <AnimatedSection delay={0.4}>
                                    <div 
                                        className="bg-cover bg-center text-white text-center p-12 rounded-2xl"
                                        style={{
                                            backgroundImage: `
                                                linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)),
                                                url('/discover.png'),
                                    ...
                                    >
                                        <h3 className="text-3xl font-[300] tracking-tight mb-6">Discover your perfect <br />property today</h3>
                                        <button className="bg-white text-black px-5 py-2 rounded-full font-[400] hover:bg-black hover:text-white transition-colors">
                                            Schedule tour
                                        </button>
                                    </div>
                                </AnimatedSection>
            ...
            <AnimatedSection>
                <footer className="bg-black text-white py-20 px-6">
                    <div className="max-w-7xl mx-auto px-36">
                        <div className="grid md:grid-cols-2 lg:grid-cols-[40%_20%_20%_20%] gap-8">
                            ...
                            <div className="pt-8">
                                <div className="flex flex-col md:flex-row justify-between items-center">
                                    <div className="mb-4 md:mb-0 space-y-2">
                                        ...
                                        <p>Email: elevate@elevdev.com</p>
                                        <p>Address: 123 Development Ave, Suite 100</p>
                                    </div>
                                </div>
                            </div>
